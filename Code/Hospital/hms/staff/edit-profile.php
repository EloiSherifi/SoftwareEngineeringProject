...
$sql=mysqli_query($con,"Update staff set staffName='$staffname',address='$staffaddress',contactno='$staffcontactno' where id='".$_SESSION['id']."'");
if($sql)
{
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Staff | Edit Staff Details</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Staff</span>
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								<div class="col-md-12">
									...
									<?php $sql=mysqli_query($con,"select * from staff where staffEmail='".$_SESSION['dlogin']."'");
...
<?php } ?>
<hr /><form role="form" name="adddoc" method="post" onSubmit="return valid();">
